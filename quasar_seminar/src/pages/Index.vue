  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'no_ktp', label: 'KTP', field: 'no_ktp', sortable: true },
        { name: 'tanggal_pemesanan', label: 'Tanggal pemesanan', field: 'tanggal_pemesanan', sortable: true },
        { name: 'tanggal_keluar', label: 'Tanggal keluar', field: 'tanggal_keluar', sortable: true },
        { name: 'jumlah_kamar', label: 'Jumlah boking', field: 'jumlah_boking', sortable: true },
